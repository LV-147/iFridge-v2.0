...
@interface SearchViewController () <UINavigationControllerDelegate, UITextFieldDelegate, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating>
